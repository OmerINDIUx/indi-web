                ...
                <div class="units-text-scroll">
                    ...
                    <div class="unit-box-trigger" data-unit="3">
                        <div class="unit-identity">
                            ...
                            <h2 class="indi-heading u-title indi-scroll-text">INDI FERROVIΛRIO</h2>
                        </div>
                ...
                <div class="project-map-stage">
                    <div class="map-wrapper" id="mexicoMapContainer">
                        ...
                        <svg viewBox="0 0 520 440" class="mexico-map-svg" id="mexicoMap">
                            ...
                            <!-- Location Markers -->
                            <!-- CDMX -->
                            <circle class="project-marker marker-cdmx" cx="295" cy="310" r="10" />
                            <!-- Southeast (Yucatan/Tren Maya) -->
                            <circle class="project-marker marker-southeast" cx="465" cy="315" r="10" />
                            <!-- Northeast (Altamira/Tamaulipas) -->
                            <circle class="project-marker marker-northeast" cx="335" cy="200" r="10" />
                        </svg>
                    </div>
                </div>
                ...
                <div class="project-data-scroll">
                    ...
                    <div class="project-data-card" data-state="southeast">
                        <div class="project-white-card">
                            <h2 class="project-name">ROMPE OLΛS SΛLINΛ CRUZ</h2>
                            ...
                            <p class="project-description">
                                Construcción del rompeolas oeste en el puerto de Salina Cruz, una obra monumental de ingeniería marítima diseñada para potenciar el corredor interoceánico y asegurar la estabilidad portuaria ante condiciones extremas.
                            </p>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 3rem;">
                    ...
                    <div class="blog-card">
                        ...
                        <div class="indi-card-notch">
                            <img src="{{ $post->thumbnail ?? 'https://images.unsplash.com/photo-1549497538-3012255366a4?auto=format&fit=crop&q=80&w=1200' }}" alt="{{ $post->title }}">
                        </div>
                    </div>
                    @empty
                    ...
                    <div class="blog-card">
                        ...
                        <div class="indi-card-notch">
                            <img src="https://images.unsplash.com/photo-1541888946425-d81bb19480c5?auto=format&fit=crop&q=80&w=800" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                    </div>
                    ...
                    <div class="blog-card">
                        ...
                        <div class="indi-card-notch">
                            <img src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&q=80&w=800" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                    </div>
                    ...
                    <div class="blog-card">
                        ...
                        <div class="indi-card-notch">
                            <img src="https://images.unsplash.com/photo-1494412519320-aa613dfb7738?auto=format&fit=crop&q=80&w=800" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                    </div>
                    @endforelse
                </div>
