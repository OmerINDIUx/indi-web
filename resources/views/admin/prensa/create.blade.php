...
@section('title', 'CMS - Crear Artículo de Prensa')
        ...
        <div style="background: white; padding: 3rem; box-shadow: 0 10px 30px rgba(0,0,0,0.05); border-radius: 8px; font-family: 'usual', sans-serif;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 3rem; border-bottom: 1px solid #eee; padding-bottom: 2rem;">
                <h1 class="indi-heading" style="font-size: 2rem; margin: 0; color: var(--indi-dark);">
                    CREΛR <span style="color: #ffa608;">ΛRTÍCULO</span> DΞ PRENSΛ
                </h1>
            ...
            <form method="POST" action="{{ route('admin.prensa.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="editor-layout-wrapper">
                    <div class="editor-left-panel">
                        ...
                        <div style="margin-bottom: 2rem;">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Ej: Avances Tecnológicos en el Tramo 5" style="width: 100%; padding: 1rem; border: 1px solid #cbd5e1; border-radius: 4px; font-size: 1rem; font-family: 'usual', sans-serif; box-sizing: border-box;" required>
                        ...
                        <div style="margin-bottom: 2rem;">
                            ...
                            <select name="category" id="category" style="width: 100%; padding: 1rem; border: 1px solid #cbd5e1; border-radius: 4px; font-size: 1rem; font-family: 'usual', sans-serif; background: white; box-sizing: border-box;" required>
                                ...
                                <option value="maritimo" {{ old('category') == 'maritimo' ? 'selected' : '' }}>MΛRÍTIMO</option>
                                <option value="infraestructura" {{ old('category') == 'infraestructura' ? 'selected' : '' }}>INFRΛΞSTRUCTURΛ</option>
                                <option value="ferroviario" {{ old('category') == 'ferroviario' ? 'selected' : '' }}>FΞRROVIΛRIO</option>
                            </select>
                        </div>

                        <!-- Imagen Portada / Thumbnail -->
                        <div style="margin-bottom: 2rem;">
                            ...
                            <small style="color: #64748b; margin-top: 0.3rem; display: block;">Tamaño sugerido: Relación 4:3 (Ej: 800x600px). Formatos admitidos: JPG, PNG, WEBP. Máx: 3MB.</small>
                        </div>
                        ...
                        <div style="margin-bottom: 3rem; display: flex; align-items: center; gap: 0.5rem; margin-top: 2.5rem;">
                            <input type="checkbox" name="is_published" id="is_published" value="1" {{ old('is_published') ? 'checked' : '' }} style="width: 1.2rem; height: 1.2rem; cursor: pointer;">
                            <label for="is_published" style="font-weight: 600; color: #334155; cursor: pointer; user-select: none;">Publicar directamente (Marcar para que aparezca en el sitio web)</label>
                        </div>

                        <!-- Botón Guardar -->
                        <div style="display: flex; gap: 1rem; border-top: 1px solid #eee; padding-top: 2rem; margin-bottom: 2rem;">
                            <button type="submit" style="background: #ffa608; color: white; padding: 1rem 2.5rem; border: none; border-radius: 4px; font-weight: 700; font-size: 1rem; cursor: pointer; font-family: 'usual', sans-serif;">Guardar Artículo</button>
