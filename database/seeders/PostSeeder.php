...
class PostSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Post::create([
            ...
            'content' => '<p>La construcción del Tren Maya representa uno de los proyectos ferroviarios más ambiciosos del siglo XXI en América Latina. Grupo INDI ha liderado de manera proactiva la ejecución técnica de los Tramos 3 y 5, integrando tecnología de precisión y estándares internacionales de ingeniería ferroviaria.</p>
        ...
        Post::create([
            ...
            'category' => 'maritimo',
            'thumbnail' => null,
            'content' => '<p>La construcción de infraestructura marítima representa uno de los desafíos más complejos de la ingeniería moderna. En Grupo INDI, hemos perfeccionado los procesos logísticos necesarios para la creación de rompeolas de gran escala, fundamentales para la protección de terminales portuarias y el desarrollo del comercio marítimo nacional.</p>
            ...
            <blockquote>"La eficiencia logística y la exactitud en la colocación hidráulica son los pilares fundamentales que distinguen cada desarrollo portuario de Grupo INDI."</blockquote>
        ...
        Post::create([
            ...
            'thumbnail' => null,
            'content' => '<p>El desarrollo de infraestructura vial masiva ha encontrado un nuevo estándar de ejecución tecnológica en el sureste del país. Grupo INDI ha implementado metodologías BIM avanzadas y plantas dosificadoras automatizadas para garantizar pavimentos asfálticos y estructuras de concreto de durabilidad centenaria.</p>
        ...
        Post::create([
            ...
            'category' => 'maritimo',
            'thumbnail' => null,
            'content' => '<p>Para optimizar la capacidad operativa de los muelles e hidrovías nacionales, Grupo INDI ha incorporado modernos sistemas de dragado hidráulico de succión por arrastre. Esta maquinaria permite remover sedimentos a profundidades de hasta 30 metros con una eficiencia ecológica única.</p>
