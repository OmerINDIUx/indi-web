...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $rows = [
            ...
            ['General', 'footer.environmental_awareness.text', 'Footer: conciencia ambiental texto', 'INDI promueve activamente acciones que favorecen la conservacion y el cuidado del medio ambiente, comprometiendose a utilizar de manera racional y eficiente los recursos naturales en todos sus proyectos. Como parte de sus iniciativas, el grupo implementa la recoleccion de equipos, materiales y accesorios electronicos, los cuales son enviados a centros de acopio y reciclaje certificados.', 'INDI actively promotes actions that support environmental protection and conservation, committing to the rational and efficient use of natural resources across all projects. As part of these initiatives, the group collects electronic equipment, materials, and accessories, which are sent to certified collection and recycling centers.', true],
            ...
            ['Negocios', 'business.maritime.desc', 'Negocios: maritimo descripcion', 'INDI ha sido un actor clave en el desarrollo de la infraestructura maritima y portuaria en Mexico, contribuyendo de manera significativa al crecimiento del comercio y la conectividad en el pais. El compromiso con la calidad y la innovacion ha permitido que sus proyectos maritimos y portuarios cumplan con los mas altos estandares internacionales, posicionando a Mexico como un hub logistico competitivo.', 'INDI has been a key player in the development of maritime and port infrastructure in Mexico, making a significant contribution to trade growth and national connectivity. Its commitment to quality and innovation has allowed maritime and port projects to meet the highest international standards, positioning Mexico as a competitive logistics hub.', true],
            ['Negocios', 'business.maritime.detail', 'Negocios: maritimo detalle', 'A lo largo de su trayectoria, ha ejecutado proyectos de alta complejidad tecnica en diversos puertos estrategicos, que han fortalecido la capacidad operativa del sistema portuario mexicano. Entre sus obras mas destacadas se incluyen la construccion y modernizacion de muelles, escolleras, terminales portuarias, y obras de dragado, todas disenadas para garantizar la seguridad operativa.', 'Throughout its history, INDI has delivered highly complex technical projects in strategic ports, strengthening the operational capacity of Mexico port system. Its key works include the construction and modernization of docks, breakwaters, port terminals, and dredging works designed to ensure operational safety.', true],
            ...
            ['Prensa', 'press.title', 'Prensa: titulo', 'CONOCE LAS ULTIMAS NOTICIAS DE INDI', 'DISCOVER THE LATEST NEWS FROM INDI', false],
            ...
            ['Prensa', 'press.coming_soon_text', 'Prensa: proximamente texto', 'Estamos preparando nuevos articulos y novedades de INDI.', 'We are preparing new articles and updates from INDI.', true],
            ...
            ['Social', 'social.environment.text', 'Social: ambiente texto', 'En INDI nos preocupa cada detalle por lo que una de nuestras principales metas es trabajar cada obra con conciencia ambiental y de preservacion animal.', 'At INDI, every detail matters. One of our main goals is to carry out each project with environmental awareness and a commitment to animal preservation.', true],
